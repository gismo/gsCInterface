...
{ return reinterpret_cast<gsCMatrixInt*>(new gsMatrix<int>()); }

GISMO_EXPORT gsCMatrixInt * gsMatrixInt_create_rc(int rows, int cols)
{ return reinterpret_cast<gsCMatrixInt*>(new gsMatrix<int>(rows,cols)); }

GISMO_EXPORT gsCMatrixInt * gsMatrixInt_create_rcd(int rows, int cols, int * data)
{ return reinterpret_cast<gsCMatrixInt*>(new gsMatrix<int>(gsAsMatrix<int>(data,rows,cols))); }
